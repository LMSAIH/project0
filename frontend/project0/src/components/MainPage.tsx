  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/getprojectinfo', {
        ...
        body: JSON.stringify({ message: projectDescription }),
      });
              ...
              <div className="prose prose-invert max-w-none">
                <div className="mb-6">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    {projectInfo.main_features?.map((feature: any, index: number) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      {Array.isArray(projectInfo.tech_stack) && projectInfo.tech_stack.map((tech: any, index: number) => (
